...
- [ ] T004 Define brand/accessibility/resilience quality checklist for this feature
...
- [ ] T011 [P] Add external dependency fallback patterns (APIs/forms/ArcGIS links)
- [ ] T012 [P] Define contract update checklist for `src/data` and rendering components
...
- [ ] T015 [P] [US1] Accessibility regression test for [journey/component]
...
- [ ] T022 [US1] Add user-facing fallback content for dependency failure states
...
- [ ] T025 [P] [US2] Accessibility regression test for [journey/component]
...
- [ ] T030 [US2] Validate content/schema compatibility with existing components
...
- [ ] T033 [P] [US3] Accessibility regression test for [journey/component]
...
- [ ] TXXX [P] Verify external links and ArcGIS resources referenced by changed pages
- [ ] TXXX [P] Run `pnpm run check:toolchain` and `pnpm build` before merge
