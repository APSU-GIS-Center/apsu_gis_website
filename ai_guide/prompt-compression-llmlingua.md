...
source: https://www.freecodecamp.org/news/how-to-compress-your-prompts-and-reduce-llm-costs/
...
tags:
    - clippings
description: Every developer working with large language models eventually faces the same challenge: prompts keep getting longer, models keep getting slower, and API bills keep getting higher. Whether you’re building a retrieval-augmented generation (RAG) system ...
summary: ""
---
...
Whether you’re building a [retrieval-augmented generation](https://www.freecodecamp.org/news/mastering-rag-from-scratch/) (RAG) system or a chatbot that remembers past conversations, every extra token adds cost and latency.

Microsoft quietly introduced a fix that few people outside research circles noticed, with a project called [LLMLingua](https://github.com/microsoft/LLMLingua). It compresses prompts before sending them to a model, keeping only the most important information. The result is faster responses, smaller bills, and an easier path to scaling LLMs.
...
- [The Problem Hidden in Plain Sight](https://www.freecodecamp.org/news/how-to-compress-your-prompts-and-reduce-llm-costs/#heading-the-problem-hidden-in-plain-sight)
- [What LLMLingua Does Differently](https://www.freecodecamp.org/news/how-to-compress-your-prompts-and-reduce-llm-costs/#heading-what-llmlingua-does-differently)
- [Working with LLMLingua](https://www.freecodecamp.org/news/how-to-compress-your-prompts-and-reduce-llm-costs/#heading-working-with-llmlingua)
- [Handling Long Contexts with LongLLMLingua](https://www.freecodecamp.org/news/how-to-compress-your-prompts-and-reduce-llm-costs/#heading-handling-long-contexts-with-longllmlingua)
- [LLMLingua-2: Faster and Smarter](https://www.freecodecamp.org/news/how-to-compress-your-prompts-and-reduce-llm-costs/#heading-llmlingua-2-faster-and-smarter)
- [Structured Prompt Compression](https://www.freecodecamp.org/news/how-to-compress-your-prompts-and-reduce-llm-costs/#heading-structured-prompt-compression)
- [SecurityLingua: Compression as a Defense](https://www.freecodecamp.org/news/how-to-compress-your-prompts-and-reduce-llm-costs/#heading-securitylingua-compression-as-a-defense)
- [Integration with the Ecosystem](https://www.freecodecamp.org/news/how-to-compress-your-prompts-and-reduce-llm-costs/#heading-integration-with-the-ecosystem)
- [Why LLM Lingua Matters](https://www.freecodecamp.org/news/how-to-compress-your-prompts-and-reduce-llm-costs/#heading-why-llm-lingua-matters)
- [Conclusion](https://www.freecodecamp.org/news/how-to-compress-your-prompts-and-reduce-llm-costs/#heading-conclusion)

## The Problem Hidden in Plain Sight

When an LLM processes a prompt, every token counts toward your cost and the model’s attention limit.

For [context-heavy applications](https://www.turingtalks.ai/p/how-ai-agents-remember-things-the-role-of-vector-stores-in-llm-memory), it’s common to hit the maximum token window long before you reach the useful part of your data.
...
[LongLLMLingua](https://llmlingua.com/longllmlingua.html) extends this concept to massive inputs like PDFs, transcripts, or multi-document retrievals. It reorders and filters context dynamically to ensure that the model sees only the most relevant sections.
...
Microsoft’s team didn’t stop there. They introduced [LLMLingua-2](https://llmlingua.com/llmlingua2.html), which is faster and more general-purpose.
...
Instead of being a standalone research prototype, it’s already integrated into popular frameworks like [LangChain](https://www.turingtalks.ai/p/langchain-vs-langgraph), LlamaIndex, and Microsoft Prompt Flow.
